...
public class OZConstants {
    ...
    public static final String PAYTM_MERCHANT_ID = "Giantl00830321943927";
    ...
    public static String OZ_ENVIRONMENT = "DEVELOPMENT";
    public static String OZ_REST_URL = "http://ec2-54-254-210-45.ap-southeast-1.compute.amazonaws.com:5000";
}
