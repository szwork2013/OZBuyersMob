...
// Response bundle contains the merchant response parameters.
                Toast.makeText(getApplicationContext(), "TXN Failure", Toast.LENGTH_SHORT).show();
...
// Error Message describes the reason for failure.
                ...
                Toast.makeText(getApplicationContext(), "Authenticatn Error  " + inErrorMessage, Toast.LENGTH_SHORT).show();
                PaymentActivity.this.finish();
            }
...
// Failing Url is the Url that failed to load.
                Toast.makeText(getApplicationContext(), "webvierw Error", Toast.LENGTH_SHORT).show();
            }
        });
    }
